...
function Xe(t, e, n, s, r, o, l, u, a, h, g, d) {
  ...
  for (b = _; b--;) {
      const w = d(r, o, b),
          L = n(w);
      let k = l.get(L);
      k ? s && k.p(w, e) : ((k = h(L, w)), k.c()),
          y.set(L, (C[b] = k)),
          L in m && q.set(L, Math.abs(b - m[L]));
  }
  const T = new Set(),
      R = new Set();
...
function Ye(t, e, n, s) {
  ...
  r && r.m(e, n),
      ...
      ue(() => {
          ...
          t.$$.on_destroy ? t.$$.on_destroy.push(...l) : X(l),
              (t.$$.on_mount = []);
      }),
      o.forEach(ue);
}
...
function et(t, e) {
  t.$$.dirty[0] === -1 && (Y.push(t), We(), t.$$.dirty.fill(0)),
      ...
      ((h.ctx = n ?
              n(t, e.props || {}, (d, f, ..._) => {
                  ...
                  return (
                      h.ctx &&
                      r(h.ctx[d], (h.ctx[d] = b)) &&
                      (!h.skip_bound && h.bound[d] && h.bound[d](b), g && et(t, d)),
                      f
                  );
              }) :
              []),
...
x.prototype.removeListener = function(e, n) {
  ...
  if (s === n || s.listener === n)
      ...
      (delete r[e],
          r.removeListener && this.emit("removeListener", e, s.listener || n));
      ...
      o === 0 ? s.shift() : ot(s, o),
          s.length === 1 && (r[e] = s[0]),
          r.removeListener !== void 0 && this.emit("removeListener", e, u || n);
  }
  return this;
};
...
async function U(t, e) {
  return fetch(`http://${GetParentResourceName()}/${t}`, {
      ...
      .then((n) => n.json())
      .catch((n) => {
          console.error("Erro de solitação", n)
          console.log(`http://${GetParentResourceName()}/${t}`)
...
function ke(t) {
  ...
  return {
      c() {
          ...
          f.c(),
              ...
              i(
                  r,
                  "class",
                  "[font-size:2.625rem] [line-height:2.5625rem] font-bold svelte-1yqod2k"
              ),
              i(
                  s,
                  "class",
                  "w-full mb-[1.9375rem] flex items-center justify-between svelte-1yqod2k"
              ),
              i(
                  u,
                  "class",
                  "h-[54rem] fixed left-[5.375rem] border-l-2 border-cr/30 rounded-lg svelte-1yqod2k"
              ),
              i(
                  n,
                  "class",
                  "w-[21.25rem] h-[56.8rem] ml-[8.0625rem] relative svelte-1yqod2k"
              ),
              i(
                  e,
                  "class",
                  ...
                  ' bg-[url("./assets/bg_cr.png")] bg-no-repeat bg-cover select-none svelte-1yqod2k'
              );
      },
      m(y, q) {
          Z(y, e, q),
      ...
      p(y, q) {
          d === (d = g(y)) && f ?
              f.p(y, q) :
              (f.d(1), (f = d(y)), f && (f.c(), f.m(s, null))),
              b === (b = _(y)) && m ?
              m.p(y, q) :
              (m.d(1), (m = b(y)), m && (m.c(), m.m(n, h))),
              y[2] ?
              C ?
              C.p(y, q) :
              ((C = Ce(y)), C.c(), C.m(n, null)) :
              C && (C.d(1), (C = null));
      },
      d(y) {
          y && S(e), f.d(), m.d(), C && C.d();
...
function ft(t) {
  ...
  return {
      c() {
          (e = p("button")),
          (e.innerHTML =
              '<span class="[font-size:1rem] [line-height:1.5rem] font-medium tracking-widest uppercase svelte-1yqod2k">Criar Sala</span>'),
          i(
              e,
              "class",
              "w-[9.9375rem] h-[2.3125rem] bg-cr hover:[box-shadow:_0px_0px_35px_rgba(65,_130,_226,_0.36)] rounded svelte-1yqod2k"
          );
      },
      m(r, o) {
...
function dt(t) {
  ...
  return {
      c() {
          (e = p("button")),
          (e.textContent = "Meu Grupo"),
          i(
              e,
              "class",
              "w-[9.9375rem] h-[2.3125rem] grid place-items-center [font-size:1rem] [line-height:1.5rem] font-medium bg-cr hover:[box-shadow:_0px_0px_36px_rgba(65,_130,_226,_0.36)] rounded uppercase svelte-1yqod2k"
          );
      },
      m(r, o) {
...
function pt(t) {
  ...
  return {
      c() {
          ...
          (q = p("button")),
          (q.innerHTML =
              '<span class="text-base font-medium uppercase svelte-1yqod2k">Sair do Grupo</span>'),
          (T = M()),
          (R = p("hr")),
          (z = M()),
          (w = p("section")),
          (L = p("span")),
          (L.textContent = "Membros"),
          (k = M()),
          (P = p("section"));
          ...
          i(
                  r,
                  "class",
                  "[font-size:0.75rem] [line-height:1.125rem] text-cr font-normal svelte-1yqod2k"
              ),
              i(
                  a,
                  "class",
                  "[font-size:1.25rem] [line-height:1.875rem] font-medium truncate uppercase svelte-1yqod2k"
              ),
              i(_, "stroke", "white"),
              i(_, "stroke-width", "1.5"),
              i(_, "stroke-linecap", "round"),
              i(_, "stroke-linejoin", "round"),
              i(
                  _,
                  "d",
                  "M13 15.2222C13 14.1755 13 13.6522 12.8708 13.2263C12.58 12.2675 11.8297 11.5172 10.8709 11.2263C10.445 11.0972 9.92167 11.0972 8.875 11.0972H5.125C4.07833 11.0972 3.55499 11.0972 3.12914 11.2263C2.17034 11.5172 1.42003 12.2675 1.12918 13.2263C1 13.6522 1 14.1755 1 15.2222M10.375 5.09717C10.375 6.96113 8.86396 8.47217 7 8.47217C5.13604 8.47217 3.625 6.96113 3.625 5.09717C3.625 3.23321 5.13604 1.72217 7 1.72217C8.86396 1.72217 10.375 3.23321 10.375 5.09717Z"
              ),
              i(_, "class", "svelte-1yqod2k"),
              i(f, "class", "w-[0.875rem] h-4 fill-none svelte-1yqod2k"),
              i(f, "viewBox", "0 0 14 16"),
              i(f, "xmlns", "http://www.w3.org/2000/svg"),
              i(
                  m,
                  "class",
                  "pt-1 [font-size:1rem] [line-height:1.5rem] font-normal svelte-1yqod2k"
              ),
              i(d, "class", "flex items-center space-x-[0.5625rem] svelte-1yqod2k"),
              i(u, "class", "flex items-center justify-between svelte-1yqod2k"),
              i(s, "class", "grid svelte-1yqod2k"),
              i(
                  q,
                  "class",
                  "w-[17.5rem] h-8 bg-cr hover:[box-shadow:_0px_0px_36px_rgba(65,_130,_226,_0.36)] rounded svelte-1yqod2k"
              ),
              i(
                  R,
                  "class",
                  "w-[17.5rem] [border:_1px_solid_rgba(65,_130,_226,_0.15)] svelte-1yqod2k"
              ),
              i(L, "class", "uppercase svelte-1yqod2k"),
              i(P, "class", "grid space-y-2 svelte-1yqod2k"),
              i(w, "class", "grid space-y-6 svelte-1yqod2k"),
              i(
                  n,
                  "class",
                  "w-[21.25rem] h-[54rem] py-6 px-8 space-y-8 bg-black/60 rounded svelte-1yqod2k"
              ),
              i(e, "class", "grid gap-2 svelte-1yqod2k");
      },
      m(H, V) {
          Z(H, e, V),
              c(e, n),
  ...
  return {
      c() {
          ...
          i(
              e,
              "class",
              "max-h-[54rem] block space-y-4 overflow-y-auto overflow-x-hidden direction-rtl no-scrollbar svelte-1yqod2k"
          );
      },
      m(l, u) {
          Z(l, e, u);
      ...
      p(l, u) {
          u[0] & 73744 &&
              ((r = l[4]), (n = Xe(n, u, o, 1, l, r, s, e, Qe, we, null, ge)));
      },
      d(l) {
          l && S(e);
...
function be(t) {
  ...
  return {
      c() {
          ...
          (l = p("button")),
          (l.innerHTML =
              '<svg class="w-[0.875rem] h-4 fill-none svelte-1yqod2k" viewBox="0 0 14 16" xmlns="http://www.w3.org/2000/svg"><path stroke="#4182E2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" d="M9.66667 3.66371V3.13087C9.66667 2.38483 9.66667 2.0118 9.52134 1.72685C9.39351 1.4762 9.18954 1.27241 8.93865 1.1447C8.65344 0.999512 8.28007 0.999512 7.53333 0.999512H6.46667C5.71993 0.999512 5.34656 0.999512 5.06135 1.1447C4.81046 1.27241 4.60649 1.4762 4.47866 1.72685C4.33333 2.0118 4.33333 2.38483 4.33333 3.13087V3.66371M5.66667 7.32699V10.6572M8.33333 7.32699V10.6572M1 3.66371H13M11.6667 3.66371V11.1235C11.6667 12.2425 11.6667 12.8021 11.4487 13.2295C11.2569 13.6055 10.951 13.9112 10.5746 14.1027C10.1468 14.3205 9.58677 14.3205 8.46667 14.3205H5.53333C4.41323 14.3205 3.85318 14.3205 3.42535 14.1027C3.04903 13.9112 2.74307 13.6055 2.55132 13.2295C2.33333 12.8021 2.33333 12.2425 2.33333 11.1235V3.66371" class="svelte-1yqod2k"></path></svg>'),
          (u = M()),
          i(
                  n,
                  "class",
                  "[font-size:0.875rem] [line-height:1.3125rem] text-white/50 font-normal svelte-1yqod2k"
              ),
              i(l, "class", "svelte-1yqod2k"),
              i(e, "class", "flex items-center justify-between svelte-1yqod2k");
      },
      m(d, f) {
          Z(d, e, f),
              c(e, n),
...
function mt(t) {
  ...
  return {
      c() {
          ...
          (o = p("input")),
          i(s, "stroke", "white"),
              i(s, "stroke-opacity", "0.25"),
              i(s, "stroke-width", "1.5"),
              i(s, "stroke-linecap", "round"),
              i(s, "stroke-linejoin", "round"),
              i(
                  s,
                  "d",
                  "M10.75 6.5V5C10.75 2.92893 9.07107 1.25 7 1.25C4.92893 1.25 3.25 2.92893 3.25 5V6.5M7 9.875V11.375M4.6 14.75H9.4C10.6601 14.75 11.2902 14.75 11.7715 14.5048C12.1948 14.289 12.539 13.9448 12.7548 13.5215C13 13.0402 13 12.4101 13 11.15V10.1C13 8.83988 13 8.20982 12.7548 7.72852C12.539 7.30516 12.1948 6.96095 11.7715 6.74524C11.2902 6.5 10.6601 6.5 9.4 6.5H4.6C3.33988 6.5 2.70982 6.5 2.22852 6.74524C1.80516 6.96095 1.46095 7.30516 1.24524 7.72852C1 8.20982 1 8.83988 1 10.1V11.15C1 12.4101 1 13.0402 1.24524 13.5215C1.46095 13.9448 1.80516 14.289 2.22852 14.5048C2.70982 14.75 3.33988 14.75 4.6 14.75Z"
              ),
              i(s, "class", "svelte-1yqod2k"),
              i(n, "class", "w-[0.875rem] h-4 fill-none svelte-1yqod2k"),
              i(n, "viewBox", "0 0 14 16"),
              i(n, "xmlns", "http://www.w3.org/2000/svg"),
              i(o, "maxlength", "6"),
              (o.disabled = l = t[10].Users >= 5 && !0),
              i(o, "type", "password"),
              i(o, "autocomplete", "off"),
              i(o, "placeholder", "Entrar"),
              i(
                  o,
                  "class",
                  "w-[6.5rem] h-8 bg-transparent text-base placeholder:text-white/25 font-medium text-center border border-white/25 outline-none uppercase rounded-lg svelte-1yqod2k"
              ),
              i(e, "class", "flex items-center space-x-[0.625rem] svelte-1yqod2k");
      },
      m(d, f) {
          Z(d, e, f),
              c(e, n),
              ...
              c(e, o),
              D(o, t[10].Value),
              u || ((a = [A(o, "input", h), A(o, "keydown", g)]), (u = !0));
      },
      p(d, f) {
          (t = d),
          f[0] & 16 && l !== (l = t[10].Users >= 5 && !0) && (o.disabled = l),
              f[0] & 16 && o.value !== t[10].Value && D(o, t[10].Value);
      },
      d(d) {
          d && S(e), (u = !1), X(a);
      },
...
function _t(t) {
  ...
  return {
      c() {
          (e = p("button")),
          (e.innerHTML =
              '<span class="text-base font-medium uppercase svelte-1yqod2k">Entrar</span>'),
          i(
              e,
              "class",
              "w-[6.5rem] h-8 bg-cr hover:[box-shadow:_0px_0px_36px_rgba(65,_130,_226,_0.36)] rounded svelte-1yqod2k"
          );
      },
      m(o, l) {
...
function we(t, e) {
  ...
  return {
      ...
      c() {
          ...
          k.c(),
              ...
              i(
                  a,
                  "class",
                  "[font-size:1.25rem] [line-height:1.875rem] truncate font-medium uppercase svelte-1yqod2k"
              ),
              i(s, "class", "grid svelte-1yqod2k"),
              i(m, "stroke", "white"),
              i(m, "stroke-width", "1.5"),
              i(m, "stroke-linecap", "round"),
              i(m, "stroke-linejoin", "round"),
              i(
                  m,
                  "d",
                  "M13 15.2222C13 14.1755 13 13.6522 12.8708 13.2263C12.58 12.2675 11.8297 11.5172 10.8709 11.2263C10.445 11.0972 9.92167 11.0972 8.875 11.0972H5.125C4.07833 11.0972 3.55499 11.0972 3.12914 11.2263C2.17034 11.5172 1.42003 12.2675 1.12918 13.2263C1 13.6522 1 14.1755 1 15.2222M10.375 5.09717C10.375 6.96113 8.86396 8.47217 7 8.47217C5.13604 8.47217 3.625 6.96113 3.625 5.09717C3.625 3.23321 5.13604 1.72217 7 1.72217C8.86396 1.72217 10.375 3.23321 10.375 5.09717Z"
              ),
              i(m, "class", "svelte-1yqod2k"),
              i(b, "class", "w-[0.875rem] h-4 fill-none svelte-1yqod2k"),
              i(b, "viewBox", "0 0 14 16"),
              i(b, "xmlns", "http://www.w3.org/2000/svg"),
              i(
                  y,
                  "class",
                  "pt-1 [font-size:1rem] [line-height:1.5rem] font-normal svelte-1yqod2k"
              ),
              i(_, "class", "flex items-center space-x-[0.5625rem] svelte-1yqod2k"),
              i(
                  f,
                  "class",
                  "w-full flex items-center justify-between svelte-1yqod2k"
              ),
              i(
                  n,
                  "class",
                  "w-[21.25rem] h-40 py-6 px-8 flex flex-col justify-between bg-black/60 rounded direction-ltr svelte-1yqod2k"
              ),
              (this.first = n);
      },
      m(P, j) {
      ...
      p(P, j) {
          (e = P),
          j[0] & 16 && o !== (o = e[10].Identity + "") && W(l, o),
              j[0] & 16 && h !== (h = e[10].Name + "") && W(g, h),
              j[0] & 16 && q !== (q = e[10].Users + "") && W(T, q),
              L === (L = w(e)) && k ?
              k.p(e, j) :
              (k.d(1), (k = L(e)), k && (k.c(), k.m(f, null)));
      },
      d(P) {
          P && S(n), k.d();
      },
...
function Ce(t) {
  ...
  return {
      c() {
          ...
          (R = p("section")),
          (z = p("span")),
          (z.textContent = "Privacidade"),
          (w = M()),
          (L = p("section")),
          (k = p("button")),
          (k.textContent = "Pública"),
          (P = M()),
          (j = p("button")),
          (j.textContent = "Privada"),
          (K = M()),
          (I = p("button")),
          (I.innerHTML =
              '<span class="[font-size:1rem] [line-height:2.5625rem] font-medium tracking-widest uppercase svelte-1yqod2k">Finalizar</span>'),
          i(
                  n,
                  "class",
                  "w-8 h-8 mt-4 -mr-5 float-right grid place-items-center [background:_rgba(255,_255,_255,_0.03)] hover:[background:_rgba(255,_255,_255,_0.010)] rounded svelte-1yqod2k"
              ),
              i(
                  l,
                  "class",
                  "[font-size:0.875rem] [line-height:1.3125rem] text-white/50 font-medium uppercase svelte-1yqod2k"
              ),
              i(a, "maxlength", "25"),
              i(a, "type", "text"),
              i(a, "autocomplete", "off"),
              i(a, "placeholder", "Digite o nome da sala..."),
              i(
                  a,
                  "class",
                  "w-[20.0625rem] h-[3.125rem] pl-[4.6875rem] pr-4 [font-size:0.875rem] [line-height:1.3125rem] font-medium bg-cr/50 placeholder:text-white/25 outline-none rounded-lg svelte-1yqod2k"
              ),
              i(
                  g,
                  "class",
                  "w-[3.125rem] h-[3.125rem] absolute bottom-0 left-0 grid place-items-center bg-cr/20 rounded-lg svelte-1yqod2k"
              ),
              i(o, "class", "relative space-y-3 svelte-1yqod2k"),
              i(
                  _,
                  "class",
                  "[font-size:0.875rem] [line-height:1.3125rem] text-white/50 font-medium uppercase svelte-1yqod2k"
              ),
              (m.disabled = C = t[3] === "Pública" && !0),
              i(m, "maxlength", "6"),
              i(m, "type", "password"),
              i(m, "autocomplete", "off"),
              i(m, "placeholder", "Digite a senha..."),
              i(
                  m,
                  "class",
                  "w-[20.0625rem] h-[3.125rem] pl-[4.6875rem] pr-4 [font-size:0.875rem] [line-height:1.3125rem] font-medium bg-cr/50 placeholder:text-white/25 outline-none rounded-lg svelte-1yqod2k"
              ...
              i(f, "class", "relative space-y-3 svelte-1yqod2k"),
              i(
                  z,
                  "class",
                  "[font-size:0.875rem] [line-height:1.3125rem] text-white/50 font-medium uppercase svelte-1yqod2k"
              ...
              i(
                  k,
                  "class",
                  "flex-1 [font-size:0.875rem] [line-height:1.3125rem] font-medium svelte-1yqod2k"
              ),
              ne(k, "active", t[3] === "Pública"),
              i(j, "type", "button"),
              i(
                  j,
                  "class",
              ...
              ne(j, "active", t[3] === "Privada"),
              i(
                  L,
                  "class",
                  "w-full h-[3.125rem] flex bg-cr/50 overflow-hidden rounded-lg svelte-1yqod2k"
              ),
              i(R, "class", "space-y-3 svelte-1yqod2k"),
              i(r, "class", "mt-9 mb-[2.625rem] grid space-y-3 svelte-1yqod2k"),
              i(
                  I,
                  "class",
                  "w-[15.9375rem] h-[4.0625rem] mx-auto grid place-items-center bg-cr/70 hover:[box-shadow:_0px_0px_35px_rgba(65,_130,_226,_0.35)] rounded-lg svelte-1yqod2k"
              ),
              i(
                  e,
                  "class",
                  "w-[26.875rem] h-[30.5rem] py-4 px-14 absolute bottom-0 -left-0 bg-black/60 rounded-lg svelte-1yqod2k"
              );
      },
      m(V, E) {
          Z(V, e, E),
      ...
      p(V, E) {
          E[0] & 1024 && a.value !== V[10] && D(a, V[10]),
              E[0] & 8 && C !== (C = V[3] === "Pública" && !0) && (m.disabled = C),
              E[0] & 64 && m.value !== V[6] && D(m, V[6]),
              E[0] & 8 && ne(k, "active", V[3] === "Pública"),
              E[0] & 8 && ne(j, "active", V[3] === "Privada");
      },
      d(V) {
          V && S(e), (N = !1), X(H);
      },
...
function yt(t, e, n) {
  ...
  ve("Open", (v) => {
      ...
      window.addEventListener(
          "keydown",
          (v) => v.key === "Escape" && (U("Close"), n(0, (s = !1)), m())
      );

  function m() {
      n(1, ([r, o, l] = [!0, !1, "Pública"]), r, n(2, o), n(3, l)),
          n(10, ([h, g] = ["", ""]), h, n(6, g));
  }
